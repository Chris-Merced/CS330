...
public:
	...
	void LoadLamp(float xPosition, float yPosition, float zPosition);
	void LoadMonitor(float xPosition, float yPosition, float zPosition);
	void LoadKeyboard(float xPosition, float yPosition, float zPosition);
	void GenerateKeyCap(float xPosition, float yPosition, float zPosition);
	void LoadMouse(float xPosition, float yPosition, float zPosition);
	void LoadPhone(float xPosition, float yPosition, float zPosition);
	void LoadBook(float xPosition, float yPosition, float zPosition, float xRotation, float yRotation, float zRotation);
};